...
export default function Contact() {
  ...
  return (
    <section id="contact" className="section-track contact-section">
      ...
      <div className="contact-left reveal">
        ...
        {/* Contact icon pills — no link text shown */}
        <div className="contact-icons">
          {contactItems.map((item, i) => (
            <a key={i} href={item.href} target="_blank" rel="noopener noreferrer" className="contact-icon-pill" title={item.label}>
              <span className="contact-icon-pill__icon">{item.icon}</span>
              <span className="contact-icon-pill__label">{item.label}</span>
            </a>
          ))}
        </div>
      </div>
      ...
      <div className="contact-right reveal">
        <form className="contact-form" onSubmit={handleSubmit}>
          <div className="contact-field">
            ...
            <input required type="text" name="name" value={form.name} onChange={handleChange} placeholder="Jane Doe" className="contact-input" />
          </div>
          <div className="contact-field">
            <label className="contact-label">Email</label>
            <input required type="email" name="email" value={form.email} onChange={handleChange} placeholder="jane@example.com" className="contact-input" />
          </div>
          <div className="contact-field">
            <label className="contact-label">Message</label>
            <textarea required name="message" value={form.message} onChange={handleChange} placeholder="Tell me about your project, role, or idea..." rows="5" className="contact-input contact-textarea"></textarea>
          </div>
